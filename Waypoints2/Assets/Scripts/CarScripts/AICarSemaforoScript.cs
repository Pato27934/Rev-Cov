...
public class AICarSemaforoScript : MonoBehaviour
{
    ...
    public SemaforoManager gameManager;
    ...
    void Move()
    {
        ...
        // Only slow down when detectionFlag is set
        if (detectionFlag != 0)
        {
